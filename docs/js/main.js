...
/* harmony import */ var _components_tooltip_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./components/tooltip.js */ "./src/js/components/tooltip.js");
...
new _components_tooltip_js__WEBPACK_IMPORTED_MODULE_6__["default"]();
...
window.addEventListener("DOMContentLoaded", () => {
  ...
  resizableSwiper("(max-width: 1240px)", ".team__slider", {
    loop: true,
    spaceBetween: 10,
    slidesPerView: "auto",
    freeMode: true
...
class Tooltip {
  ...
  showTooltip(tooltip) {
    let placement = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : "right";
  ...
  init() {
    document.addEventListener("mouseover", e => {
      ...
      if (tooltip) {
        ...
        const placement = tooltip.getAttribute("data-placement") || target.getAttribute("data-placement") || "right";
