...
/***/ "./src/js/components/mobile-dropdown.js":
/*!**********************************************!*\
  !*** ./src/js/components/mobile-dropdown.js ***!
  \**********************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
  ...
  function transformDropdownToRadio(dropdown, isMobile) {
    ...
    if (dropdown.querySelector(".setting-item__radio-group")) {
      if (isMobile) {
        ...
        dropdown.querySelector(".setting-item__radio-group").style.display = "flex";
      } else {
        btn.style.display = "flex";
        content.style.display = ""; // возвращаем исходное значение
        if (dropdown.querySelector(".setting-item__radio-group")) {
          dropdown.querySelector(".setting-item__radio-group").style.display = "none";
        }
      }
    }
  }
